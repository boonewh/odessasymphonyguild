...
export default function MediaReleaseModal({ isOpen, onClose }: MediaReleaseModalProps) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const formData = {
      ...
      "Age Verification": ageVerification === "18plus" ? "18 years or older" : "Under 18 years",
      "Social Media Opt-Out": socialMediaOptOut ? "Yes - Opted OUT of social media" : "No - Social media OK",
      "Adult Consent (18+)": ageVerification === "18plus" ? (participantConsent ? "Yes" : "No") : "N/A (Minor)",
      "Minor's Name": ageVerification === "under18" ? minorName : "N/A",
      "Guardian Name": ageVerification === "under18" ? guardianName : "N/A",
      "Guardian Phone": ageVerification === "under18" ? guardianPhone : "N/A",
      "Guardian Email": ageVerification === "under18" ? guardianEmail : "N/A",
      "Guardian Consent": ageVerification === "under18" ? (guardianConsent ? "Yes" : "No") : "N/A",
